...
import valentines from '../../assets/logo (1).jpg'
import shield from '../../assets/logo (1).jpg'

const Value = () => {
  return (
    <div className='mb-[4rem] mt-[6rem]'>
        <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] front-bold w-[400px] block'>
            The value that holds us trust and to account</h1>
        ...
        <div className='grid gap-[10rem] grid-cols-3 items-center'>
            ...
            <div className='singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]'>
                ...
                <p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
                    We believe in making things better for everyone, even if just by litle bit!</p>
            </div>
